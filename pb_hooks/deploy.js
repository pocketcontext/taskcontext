...
function settings(app) {
  ...
  const header = env("TASKCONTEXT_TRUSTED_PROXY_HEADER");
  if (header) {
  ...
  const limits = env("TASKCONTEXT_RATE_LIMITS");
  if (limits === "true") {
    ...
    console.log("deploy: TASKCONTEXT_RATE_LIMITS must be true or false; rate limit settings left alone");
  }
}
