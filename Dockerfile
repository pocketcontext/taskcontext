...
LABEL org.opencontainers.image.title="TaskContext" \
      org.opencontainers.image.description="Shared issue tracker operated through a coding agent: PocketContext server, issue tracker migrations and hooks, Litestream replication" \
      org.opencontainers.image.source="https://github.com/pocketcontext/taskcontext" \
